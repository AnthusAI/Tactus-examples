...
## Editorial & Quality Standards (CRITICAL)
All work in this repository must adhere to the **[EDITORIAL.md](EDITORIAL.md)** guidelines.
*   **Code**: Must Run. Must Pass Tests. Must support Mock/Real modes.
*   **Prose**: Accessible, magazine-style, jargon-conscious.
